...
const Body = () => {
  return (
    <div id="Body_1" className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div id="Body_2" className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg">
        <div id="Body_3" className="text-center">
          ...
          <p id="Body_6" className="mt-2 text-sm text-gray-600">Or start your 30-day free trial</p>
        </div>
        <LoginForm />
      </div>
    </div>
